...
export function Footer() {
  ...
  useEffect(() => {
    ...
    // #region agent log
    fetch('http://127.0.0.1:7242/ingest/8f13d096-f5b3-4a25-b1f7-9fa94764e743',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({sessionId:'debug-session',runId:'pre-fix',hypothesisId:'H4',location:'Footer.tsx:useEffect:attributionFont',message:'Computed font-family for footer attribution',data:{element:'attribution',fontFamily:attributionFont},timestamp:Date.now()})}).catch(()=>{});
    // #endregion

    // #region agent log
    fetch('http://127.0.0.1:7242/ingest/8f13d096-f5b3-4a25-b1f7-9fa94764e743',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({sessionId:'debug-session',runId:'pre-fix',hypothesisId:'H4',location:'Footer.tsx:useEffect:disclaimerFont',message:'Computed font-family for footer disclaimer',data:{element:'disclaimer',fontFamily:disclaimerFont},timestamp:Date.now()})}).catch(()=>{});
    // #endregion
  }, [])
